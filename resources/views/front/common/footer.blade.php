              ...
              <div class="modal-body">
                ...
                <form class="loginForm">
                    <div class="mb-3">
                        ...
                        <input type="email_" name="email" class="form-control" id="loginEmail" aria-describedby="emailHelp" required_>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control" id="loginPassword" name="password" minlength="8" required_>
