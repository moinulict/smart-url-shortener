          ...
          <section id="about" class="about">
              <div class="container content">
                  ...
                  <p class="text-muted mb-2">These Website Standard Terms and Conditions written on this webpage shall
                      manage your use of our website, urlgen.io accessible at https://urlgen.io.
                  </p>
                  ...
                  <p class="text-muted mb-2">Other than the content you own, under these Terms, urlgen.io
                  ...
                  <p class="text-muted mb-4">Certain areas of this Website are restricted from being access by you and
                      urlgen.io may further restrict access by you to any areas of this Website, at any
                  ...
                  <p class="text-muted mb-2">In these Website Standard Terms and Conditions, "Your Content" shall mean
                      ...
                      displaying Your Content, you grant urlgen.io a non-exclusive, worldwide irrevocable,
                  ...
                  <p class="text-muted mb-4">Your Content must be your own and must not be invading any third-party's
                      rights. urlgen.io reserves the right to remove any of Your Content from this Website
                  ...
                  <p class="text-muted mb-4">This Website is provided "as is," with all faults, and
                      urlgen.io express no representations or warranties, of any kind related to this
                  ...
                  <p class="text-muted mb-4">In no event shall urlgen.io, nor any of its officers,
                      ...
                      urlgen.io, including its officers, directors and employees shall not be held liable
                  ...
                  <p class="text-muted mb-4">You hereby indemnify to the fullest extent urlgen.io from and
                  ...
                  <p class="text-muted mb-4">urlgen.io is permitted to revise these Terms at any time as it
                  ...
                  <p class="text-muted mb-4">The urlgen.io is allowed to assign, transfer, and subcontract
                  ...
                  <p class="text-muted mb-4">These Terms constitute the entire agreement between urlgen.io
